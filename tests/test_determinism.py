...
behind the provider seam and mitigated there by a pinned model id and
word-band confidences, which quantize a jittery output into five
buckets. That split is what makes this test meaningful rather than a
flake-magnet.
"""
